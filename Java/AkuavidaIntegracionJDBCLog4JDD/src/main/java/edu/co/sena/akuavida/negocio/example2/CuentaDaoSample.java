...
public class CuentaDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereUsusarioIdususarioEquals("");
            ...
            Cuenta cuentica = new Cuenta();
            cuentica.setTipoDocumento("C.C");
            cuentica.setNumeroDocumento("1033790199");
            cuentica.setPrimerNombre("Juan");
            cuentica.setSegundoNombre("David");
            cuentica.setPrimerApellido("Montero");
            cuentica.setSegundoApellido("Bogota");
            cuentica.setContrasena("987654321");
            cuentica.setCorreo("jdmontero0@misena.edu.co");
            cuentica.setDireccion("Calle 49 G sur # 6 A 29");
            cuentica.setTelefono("3217915742");
            cuentica.setRool("Cliente");
            cuentica.setActivo(new Short("1"));
            cuentica.setUsusarioIdususario("1");
            
            
            CuentaDao daoCuenta = getCuentaDao();
            daoCuenta.insert(cuentica);
            
            System.out.println("__________");
            
            cuentica.setContrasena("000000000");
            daoCuenta.update(cuentica.createPk(), cuentica);
            findAll();
	}
