...
public class DomicilioDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereTelefonoEquals("");
            ...
            domi.setMunicipioIdmunicipio("1115");
            domi.setCuentaTipoDocumento("C.C");
            domi.setCuentaNumeroDocumento("1033790199");
            domi.setCiudad("Bogota");
            domi.setDireccion("Calle 49 G # 6 A 29");
            domi.setTelefono("32179155742");
            
            
            DomicilioDao daoDomi = getDomicilioDao();
            daoDomi.insert(domi);
            
            System.out.println("________");

            domi.setTelefono("7605996");
            daoDomi.update(domi.createPk(), domi);
            findAll();
