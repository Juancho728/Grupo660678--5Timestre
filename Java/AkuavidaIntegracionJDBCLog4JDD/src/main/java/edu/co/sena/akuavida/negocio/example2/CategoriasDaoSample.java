...
public class CategoriasDaoSample {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        categoria.setNombre("Purificadores de acero xxx");
        categoria.setActiva(new Short("1"));
        categoria.setPariente(1);
        
        CategoriasDao daoCategoria = getCategoriasDao();
        daoCategoria.insert(categoria);       
//        findAll();        
        System.out.println("-----");
        categoria.setNombre("Purificador");
        daoCategoria.update(categoria.createPk(), categoria);
        findAll();
