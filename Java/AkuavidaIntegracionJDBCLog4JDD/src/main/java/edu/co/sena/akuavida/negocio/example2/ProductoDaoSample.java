...
public class ProductoDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereCategoriasIdCategoriaEquals(0);
            ...
            pro.setIdProducto("1");
            pro.setNombre("Purificador de manzana");
            pro.setPrecio(250000);
            pro.setDescripcion("El nuevo purificador que le agradara");
            pro.setCantidad(25);
            pro.setActivo(new Short("1"));
            pro.setImpuesto(16);
            pro.setCategoriasIdCategoria(1);
            
            ProductoDao daoPro = getProductoDao();
            daoPro.insert(pro);
            
            System.out.println("_________");
            
            
            pro.setCantidad(100000);
            daoPro.update(pro.createPk(), pro);
            findAll();
