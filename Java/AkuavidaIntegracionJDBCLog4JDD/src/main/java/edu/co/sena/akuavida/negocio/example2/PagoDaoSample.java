...
public class PagoDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereNumeroTarjetaEquals("");
            ...
            Pago pa = new Pago();
            pa.setFacturaIdFactura(1);
            pa.setTipoPago("Tarjeta Debito");
            pa.setNumeroTarjeta("1234-5678-9012-7286");
            
            PagoDao daoPago = getPagoDao();
            daoPago.insert(pa);
            
            System.out.println("__________________");
            
            
            pa.setNumeroTarjeta("2345-5678-9012-7286");
            daoPago.update(pa.createPk(), pa);
            findAll();
	}
