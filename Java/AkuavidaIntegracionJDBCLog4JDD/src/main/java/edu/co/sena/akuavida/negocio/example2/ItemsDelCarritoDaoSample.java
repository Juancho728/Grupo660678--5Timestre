...
public class ItemsDelCarritoDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereCarritoDeComprasIdCarritoEquals("");
            ...
            ItemsDelCarrito itemca = new ItemsDelCarrito();
            itemca.setProductoIdProducto("1");
            itemca.setCantidad(10);
            itemca.setCostoUnitario(250000);
            itemca.setCostoTotal(0);
            itemca.setCarritoDeComprasIdCarrito("agsvbfdbvjdb1");
            
            ItemsDelCarritoDao daoItemCarrito = getItemsDelCarritoDao();
            daoItemCarrito.insert(itemca);
            
            System.out.println(" ________");
                    
            itemca.setCantidad(20);
            daoItemCarrito.update(itemca.createPk(), itemca);
            findAll();
	}
