...
public class InventarioDaoSample {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        inv.setCantidad(25);
        inv.setProductoIdProducto("1");
        inv.setCantidadProductoComprado(20);
        inv.setFechaDeCompra(fechaActual);
        
        
        InventarioDao daoInv = getInventarioDao();
        daoInv.insert(inv);
        
        System.out.println("______________");
        
        inv.setCantidad(50);
        daoInv.update(inv.createPk(), inv);
        findAll();
    }
