...
//		 findAll();
		...
		// findWhereSubtotalEquals(0);
            ...
            carrito.setIdCarrito("agsvbfdbvjdb1");
            carrito.setSubtotal(0);
            carrito.setTotal(0);
            
            CarritoDeComprasDao daoCarrito = getCarritoDeComprasDao();
            daoCarrito.insert(carrito);
            
            System.out.println("_____________");
            
            carrito.setSubtotal(150000);
            daoCarrito.update(carrito.createPk(), carrito);
            findAll();
