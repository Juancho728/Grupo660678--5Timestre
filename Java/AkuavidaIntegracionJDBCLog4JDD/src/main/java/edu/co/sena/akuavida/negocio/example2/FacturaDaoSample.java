...
public class FacturaDaoSample {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        Calendar hoy = Calendar.getInstance(TimeZone.getTimeZone("GM-5"));
        Date fechaActual = hoy.getTime();

        Factura fac = new Factura();
        fac.setIdFactura(4);
        fac.setFecha(fechaActual);
        fac.setCuentaTipoDocumento("C.C");
        fac.setCuentaNumeroDocumento("1033790199");

        FacturaDao daoFac = getFacturaDao();
        daoFac.insert(fac);

        System.out.println("_________");

        fac.setFecha(fechaActual);
        daoFac.update(fac.createPk(), fac);
        findAll();
